...
export default function Login() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        title: "Welcome back!",
        description: "Successfully logged in to AsaforVTU Admin.",
      });
      setLocation("/");
    } catch (error: any) {
        ...
        <CardHeader className="space-y-4 text-center pb-8">
          ...
          <div>
            ...
            <CardDescription className="text-base">
              Enter your credentials to access the AsaforVTU dashboard
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input className="pl-9 bg-white" placeholder="admin@AsaforVTU.com" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
