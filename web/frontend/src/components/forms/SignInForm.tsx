  ...
  return (
    <div className="max-w-md w-full space-y-10 p-10 bg-white/80 backdrop-blur-xl rounded-[3rem] shadow-2xl border border-slate-100 relative overflow-hidden">
      ...
      <div>
        ...
        <p className="mt-4 text-center text-slate-500 font-medium">Please enter your details to sign in</p>
      </div>
      {error && (
        ...
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center">
            <input
              ...
              name="remember-me"
              type="checkbox"
              className="h-5 w-5 text-primary focus:ring-primary border-slate-200 rounded-lg cursor-pointer"
            />
