    ...
    <footer className="bg-[#0A1F44] text-white py-12 mt-20">
      <div className="container-main">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-lg mb-4">AsaPhis</h3>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">support@AsaPhis.com</p>
            <p className="text-sm text-gray-300">+234 800 123 4567</p>
          </div>
        </div>
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} AsaPhis. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
