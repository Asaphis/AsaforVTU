...
function MobileServicesEntry() { const [, setLocation] = useLocation(); const isPhone = typeof window !== "undefined" && window.matchMedia("(max-width: 920px)").matches; useEffect(() => { if (isPhone) setLocation("/dashboard/services/data"); }, [isPhone, setLocation]); return <Authenticated><CustomerApp /></Authenticated>; }
